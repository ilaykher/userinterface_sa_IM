...
Partial Class UserInetrfaceNew
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UserInetrfaceNew))
        Label1 = New Label()
        Panel3 = New Panel()
        Panel5 = New Panel()
        Button1 = New Button()
