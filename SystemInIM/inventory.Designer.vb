...
Partial Class inventory
    ...
    Private Sub InitializeComponent()
        ...
        linkInventory.Font = New Font("Calibri", 36F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        linkInventory.LinkBehavior = LinkBehavior.NeverUnderline
        linkInventory.LinkColor = Color.Black
        linkInventory.Location = New Point(50, 25)
        linkInventory.Name = "linkInventory"
        linkInventory.Size = New Size(219, 59)
